...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "188/pipelines/customers_orders")
    MetricsCollector.start(spark = spark, pipelineId = "188/pipelines/customers_orders")
    pipeline(spark)
